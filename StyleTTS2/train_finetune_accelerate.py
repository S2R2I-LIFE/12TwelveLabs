...
def main(config_path):
    ...
    for epoch in range(start_epoch, epochs):
        ...
        with torch.no_grad():
            ...
            for batch_idx, batch in enumerate(val_dataloader):
                ...
                try:
                    ...
                    logger.warning('Validation sample skipped: %s', _val_exc)
                    continue
        ...
        if iters_test > 0:
            ...
            logger.warning('Validation: all samples were skipped — check audio sample rate and phoneme length\n\n\n')
        print('\n\n\n')
        ...
        if (epoch + 1) % save_freq == 0:
            ...
            state = {
                ...
                'iters': iters,
                'val_loss': (loss_test / iters_test) if iters_test > 0 else 0.0,
                'epoch': epoch,
            }
